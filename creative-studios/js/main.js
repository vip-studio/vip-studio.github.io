...
var materials = {
    ...
    phongMaterial: new THREE.MeshPhongMaterial({
        ...
        flatShading: true, side: THREE.DoubleSide, skinning: true
    }),
...
function initScene(index) {
    ...
    renderer.setClearColor(0x000000); //565646, 29212
...
function removeModel() {
    ...
    model_wire.checked = false; phong.checked = true; xray.checked = false;
...
var modelList = [
            {
                name: "Bone Plate", url: 'sample_models/bone-plate.obj'
            },
            {
                name: "Cutting Guide", url: 'sample_models/cutting-guide.obj'
            },
            {
                name: "Post-Osteotomy Radial Wedge", url: 'sample_models/post-osteotomy-radial-wedge.obj'
                //, objectRotation: new THREE.Euler(0, 3 * Math.PI / 2, 0)

            },
            {
                name: "Post-Osteotomy Radius Ulna L", url: 'sample_models/post-osteotomy-radius-ulna-l.obj'
            },
            {
                name: "Pre-Osteotomy Radius Ulna L", url: 'sample_models/pre-osteotomy-radius-ulna-l.obj'
            },
            {
                name: "Combined Plate PostAnatomy & Wedge", url: 'sample_models/CombinedPlatePostAnatomy&Wedge.obj'
            }
